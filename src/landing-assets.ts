...
<body>
  <main class="page-shell">
    ...
    <footer class="footer"><nav><a href="https://github.com/SunKeXu01/LuodongChat/blob/main/docs/DATA_MODEL.md">隐私说明</a><a href="https://github.com/SunKeXu01/LuodongChat#Windows-使用方式">安装帮助</a><a href="https://github.com/SunKeXu01/LuodongChat/releases/latest">更新记录</a><a href="https://github.com/SunKeXu01/LuodongChat/issues">联系我们</a></nav><a class="icp-link" href="http://beian.miit.gov.cn/">鲁ICP备2025167850号-3</a><span>v${version} · 服务正常 <i class="status-dot"></i></span></footer>
  </main>
